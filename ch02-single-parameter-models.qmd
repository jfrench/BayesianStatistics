...
&\propto\int \exp\left[-\frac{1}{2\sigma^2}(\tilde{y}-\theta)^2\right]
...
$$
E(\tilde{y}\mid y)=E\left[E(\tilde{y}\mid\theta,y)\mid y\right]=E(\theta\mid y)=\mu_n.
$$
...
+\text{var}\left[E(\tilde{y}\mid\theta,y)\mid y\right]\\
