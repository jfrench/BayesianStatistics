...
#
# We will use indicator variables when fitting this model and
# a corner constraint (alpha1 = 0) to fit this model.
...
fit <- stan(model_code = stanmod, data = stan_dat, iter = 10000)
...
# plot of densities
stan_dens(fit, par = c("mu0", "alpha2", "alpha3", "alpha4"),
